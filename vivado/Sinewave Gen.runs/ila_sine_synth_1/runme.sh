...
HD_PWD='/home/lorsi/Documents/CESE/CLP/VHDL-Sinewave-Generator/vivado/Sinewave Gen.runs/ila_sine_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_sine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_sine.tcl
