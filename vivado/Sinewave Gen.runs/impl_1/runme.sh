...
HD_PWD='/home/lorsi/Documents/CESE/CLP/VHDL-Sinewave-Generator/vivado/Sinewave Gen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sinewave_gen_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sinewave_gen_top.tcl -notrace
