...
HD_PWD='/home/lorsi/Documents/CESE/CLP/VHDL-Sinewave-Generator/vivado/Sinewave Gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sinewave_gen_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sinewave_gen_top.tcl
