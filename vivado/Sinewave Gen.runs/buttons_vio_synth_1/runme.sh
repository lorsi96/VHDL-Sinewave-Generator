...
HD_PWD='/home/lorsi/Documents/CESE/CLP/VHDL-Sinewave-Generator/vivado/Sinewave Gen.runs/buttons_vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buttons_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buttons_vio.tcl
